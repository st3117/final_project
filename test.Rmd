...
model2 = svyglm(breast_cancer ~ age + race + smoke_100 + overweight + alcohol + age_first_birth + income, family = "binomial", design = design)
broom::tidy(model1)

# full model 3, include 
...
model6 = glm(breast_cancer ~ age + race + overweight + smoke_100 + alcohol + age_first_birth + income, data = nhanes_model, family = "binomial")
broom::tidy(model6)

AIC(model6)


model7 = glm(breast_cancer ~ age + race + overweight + alcohol, data = nhanes_model, family = "binomial")
broom::tidy(model7)
